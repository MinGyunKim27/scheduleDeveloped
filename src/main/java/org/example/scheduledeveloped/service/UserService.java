...
import org.example.scheduledeveloped.exception.UserNotValid;
...
public class UserService {
    ...
    public UserResponseDto updateUser(
        ...
        if (!passwordEncoder.matches(dto.getOldPassword(),foundedUser.getPassword())){
    ...
    public void deleteUser(
        ...
        if (!passwordEncoder.matches(dto.getPassword(),byId.getPassword())){
            throw new PasswordMismatchException("비밀번호가 일치하지 않습니다.");
        }
